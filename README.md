...
Releases (pre-releases included) carry the npm tarball as a GitHub Release
asset, so no registry access is needed:
...
`npm install github:testfairy/react-native-testfairy#3.0.0-rc` — also works,
